...
fun test_check_eligibility_disabled_config() {
    ...
    let mut proposal = proposal::new_for_testing<TEST_COIN_A, TEST_COIN_B>(
        ...
        vector[string::utf8(b"Accept details"), string::utf8(b"Reject details")], // initial_outcome_details
...
fun test_complete_eligibility_workflow() {
    ...
    let mut proposal = proposal::new_for_testing<TEST_COIN_A, TEST_COIN_B>(
        ...
        vector[string::utf8(b"Accept details"), string::utf8(b"Reject details"), string::utf8(b"Abstain details")],
        vector[@0x1, @0x1, @0x1],
        3,
        86400000,
        604800000,
