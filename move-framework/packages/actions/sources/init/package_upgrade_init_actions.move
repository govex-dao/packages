...
public struct CreateCommitCapAction has copy, drop, store {
    name: String, // Package name
...
public fun add_commit_spec(builder: &mut action_spec_builder::Builder, name: String) {
    use account_actions::action_spec_builder as builder_mod;
...
public fun add_restrict_spec(builder: &mut action_spec_builder::Builder, name: String, policy: u8) {
    use account_actions::action_spec_builder as builder_mod;
