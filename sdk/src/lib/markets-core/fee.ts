...
export class Fee {
   ...
   * Emits StableFeesCollected event.
   *
   * @param tx - Transaction
   * @param config - Configuration
   */
   ...
   * Emits StableFeesCollected event (same event for both asset and stable).
   *
   * @param tx - Transaction
   * @param config - Configuration
   */
   ...
   * Emits StableFeesWithdrawn event.
   *
   * @param tx - Transaction
   * @param config - Configuration
   */
   ...
   * Emits StableFeesWithdrawn event (same event for both asset and stable).
   *
   * @param tx - Transaction
   * @param config - Configuration
   */
